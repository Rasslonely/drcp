...
export interface DRCPGovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
  ...
  encodeFunctionData(
    functionFragment: "UPGRADE_SUPERMAJORITY_BPS",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export namespace UpgradeProposalCreatedEvent {
  export type InputTuple = [
    proposalId: BigNumberish,
    proposer: AddressLike,
    description: string
...
export interface DRCPGovernor extends BaseContract {
  connect(runner?: ContractRunner | null): DRCPGovernor;
  waitForDeployment(): Promise<this>;

  interface: DRCPGovernorInterface;
  ...
  UPGRADE_SUPERMAJORITY_BPS: TypedContractMethod<[], [bigint], "view">;
  ...
  proposeEmergency: TypedContractMethod<
    [
      targets: AddressLike[],
      values: BigNumberish[],
      calldatas: BytesLike[],
  ...
  getFunction(
    nameOrSignature: "UPGRADE_SUPERMAJORITY_BPS"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "proposeEmergency"
  ): TypedContractMethod<
    [
      targets: AddressLike[],
      values: BigNumberish[],
  ...
  >;
  getEvent(
    key: "UpgradeProposalCreated"
  ): TypedContractEvent<
    UpgradeProposalCreatedEvent.InputTuple,
    UpgradeProposalCreatedEvent.OutputTuple,
    UpgradeProposalCreatedEvent.OutputObject
  >;
  getEvent(
    key: "VoteCast"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "EmergencyProposalCreated(uint256,address,string)": TypedContractEvent<
      EmergencyProposalCreatedEvent.InputTuple,
      EmergencyProposalCreatedEvent.OutputTuple,
      EmergencyProposalCreatedEvent.OutputObject
    >;
    ...
    "UpgradeProposalCreated(uint256,address,string)": TypedContractEvent<
      UpgradeProposalCreatedEvent.InputTuple,
      UpgradeProposalCreatedEvent.OutputTuple,
      UpgradeProposalCreatedEvent.OutputObject
    >;
    UpgradeProposalCreated: TypedContractEvent<
      UpgradeProposalCreatedEvent.InputTuple,
      UpgradeProposalCreatedEvent.OutputTuple,
      UpgradeProposalCreatedEvent.OutputObject
    >;
