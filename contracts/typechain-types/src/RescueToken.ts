...
export interface RescueTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export interface RescueToken extends BaseContract {
  connect(runner?: ContractRunner | null): RescueToken;
  waitForDeployment(): Promise<this>;

  interface: RescueTokenInterface;
