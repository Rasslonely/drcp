...
export interface DRCPTimelockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CANCELLER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface DRCPTimelock extends BaseContract {
  connect(runner?: ContractRunner | null): DRCPTimelock;
  waitForDeployment(): Promise<this>;

  interface: DRCPTimelockInterface;
